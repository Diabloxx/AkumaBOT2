...
class BaseModule extends IModule
{
    constructor()
    {
        ...
        this.add_command({
            ...
            sample: "akuma what are my permissions?",
        ...
        this.add_command({
            ...
            sample: "akuma list timezones __*area*__",
