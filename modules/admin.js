...
class AdminModule extends IModule
{
    constructor()
    {
        ...
        this.add_command({
            ...
            sample: "akuma enable module __*module name*__",
        ...
        this.add_command({
            ...
            sample: "akuma disable module __*module name*__",
        ...
        this.add_command({
            ...
            sample: "akuma assign role __*role*__ to user __*@user*__",
        ...
        this.add_command({
            ...
            sample: "akuma add permission __*permission*__ to role __*role name*__",
        ...
        this.add_command({
            ...
            sample: "akuma remove permission __*permission*__ from role __*role*__",
        ...
        this.add_command({
            ...
            sample: "akuma ignore __*@user*__",
        ...
        this.add_command({
            ...
            sample: "akuma unignore __*@user*__",
        ...
        this.add_command({
            ...
            sample: "akuma go to __*#channel*__",
            description: "Tells akuma to output to the specified channel.",
